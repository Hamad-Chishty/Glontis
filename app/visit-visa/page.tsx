            ...
            <div className="relative z-20 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
                ...
                <div className="pt-6 grid grid-cols-3 gap-4 border-t border-slate-800/80 text-left">
                  ...
                  <div>
                    <span className="block text-xl sm:text-2xl font-black text-white">UK, EU, US</span>
                    <span className="text-[11px] text-slate-400 font-semibold uppercase">Key Embassies</span>
                  </div>
                  <div>
                    <span className="block text-xl sm:text-2xl font-black text-white">Multan</span>
                    <span className="text-[11px] text-slate-400 font-semibold uppercase">Official Office</span>
                  </div>
                </div>
              </div>
